              ...
              <tbody>
                ...
                >
                  <tr class="text-center">
                    <td>{{ index + 1 }}</td>
                    <td class="text-start">{{ value.ma_phieu }}</td>
  ...
  methods: {
    ...
    addPhieuNhap() {
      const payload = {
        ...
        trang_thai:
          this.them_phieu_nhap.trang_thai == 0
            ? 0
            : Number(this.them_phieu_nhap.trang_thai) || 1,
    ...
    openEdit(item) {
      ...
      axios
        ...
        .then((response) => {
          ...
          const details = response.data.chi_tiet || data.chi_tiet || [];

          this.edit_phieu_nhap = {
            id: data.phieu_nhap?.id || item.id,
            ma_phieu: data.phieu_nhap?.ma_phieu || "",
            id_kho: data.phieu_nhap?.id_kho || "",
            id_nha_cung_cap: data.phieu_nhap?.id_nha_cung_cap || "",
            id_nhan_vien: data.phieu_nhap?.id_nhan_vien || "",
            ngay_nhap: (data.phieu_nhap?.ngay_nhap || "")
              .toString()
              .slice(0, 10),
            chiet_khau: Number(data.phieu_nhap?.chiet_khau) || 0,
            thue_vat: Number(data.phieu_nhap?.thue_vat) || 0,
            da_thanh_toan: Number(data.phieu_nhap?.da_thanh_toan) || 0,
            trang_thai:
              data.phieu_nhap?.trang_thai == 0
                ? 0
                : Number(data.phieu_nhap?.trang_thai) || 1,
            ghi_chu: data.phieu_nhap?.ghi_chu || "",
    ...
    updatePhieuNhap() {
      ...
      const payload = {
        ...
        trang_thai:
          this.edit_phieu_nhap.trang_thai == 0
            ? 0
            : Number(this.edit_phieu_nhap.trang_thai) || 1,
    ...
    openChiTiet(item) {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.chi_tiet_list = response.data.chi_tiet || data.chi_tiet || [];
        })
        .catch((error) => {
