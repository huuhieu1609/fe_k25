                            ...
                            <tbody>
                                <template v-for="(value, index) in list_nhan_vien" :key="index">
                                    <tr class="text-center align-middle">
                                        ...
                                        <td>{{ value.gioi_tinh == 1 ? "Nam" : value.gioi_tinh == 0 ? "Nữ" : "Khác" }}
                                        </td>
                                        <td><button v-if="value.tinh_trang == 1" v-on:click="changeStatus(value)"
                                                class="btn btn-success btn-sm w-100">Đang làm việc</button>
                                            <button v-else v-on:click="changeStatus(value)"
                                                class="btn btn-danger btn-sm w-100">Đã nghỉ việc</button>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <button v-on:click="Object.assign(delete_Nhan_Vien, value)"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button @click="addNhanVien()" type="button" class="btn btn-primary" data-bs-dismiss="modal">Thêm
                        Nhân
                        Viên</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h5 class="fw-bold">Bạn có chắc chắn muốn xóa Nhân viên {{ delete_Nhan_Vien.ho_va_ten }} này?</h5>
                    <p class="text-muted small">Hành động này không thể hoàn tác.</p>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-secondary px-4 shadow-sm" data-bs-dismiss="modal">Hủy</button>
                    <button v-on:click="deleteNhanVien()" type="button" data-bs-dismiss="modal"
                        class="btn btn-danger px-4 shadow-sm">Xác Nhận
                        Xóa</button>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        addNhanVien() {
            ...
            axios
                .post('http://127.0.0.1:8000/api/admin/nhan-vien/create', this.them_Nhan_Vien)
                .then(response => {
        ...
        updateNhanVien() {
            axios
                .put('http://127.0.0.1:8000/api/admin/nhan-vien/update', this.edit_Nhan_Vien)
                .then(response => {
            ...
            axios
                ...
                .catch(error => {
                    ...
                    if (error.response && error.response.data && error.response.data.errors) {
                        ...
                        this.$toast.error('Đã xảy ra lỗi khi thay đổi trạng thái Nhân Viên.');
                    }
                });
        }
