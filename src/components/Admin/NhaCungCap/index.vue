        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <form>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input v-model="them_nha_cung_cap.ten" type="text" class="form-control shadow-sm" placeholder="Nhập tên nhà cung cấp">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Số Điện Thoại</label>
                                <input v-model="them_nha_cung_cap.so_dien_thoai" type="text" class="form-control shadow-sm" placeholder="Nhập số điện thoại">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Email</label>
                                <input v-model="them_nha_cung_cap.email" type="email" class="form-control shadow-sm" placeholder="Nhập email">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Địa Chỉ</label>
                                <input v-model="them_nha_cung_cap.dia_chi" type="text" class="form-control shadow-sm" placeholder="Nhập địa chỉ">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Mã Số Thuế</label>
                                <input v-model="them_nha_cung_cap.ma_so_thue" type="text" class="form-control shadow-sm" placeholder="Nhập mã số thuế">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-bold">Ghi Chú</label>
                                <textarea v-model="them_nha_cung_cap.ghi_chu" class="form-control shadow-sm" rows="3" placeholder="Nhập ghi chú"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary px-4 shadow-sm" @click="themNhaCungCap">Lưu Nhà Cung Cấp</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Tên Nhà Cung Cấp</label>
                                <input v-model="edit_nha_cung_cap.ten" type="text" class="form-control shadow-sm" placeholder="Nhập tên nhà cung cấp">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Số Điện Thoại</label>
                                <input v-model="edit_nha_cung_cap.so_dien_thoai" type="text" class="form-control shadow-sm" placeholder="Nhập số điện thoại">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Email</label>
                                <input v-model="edit_nha_cung_cap.email" type="email" class="form-control shadow-sm" placeholder="Nhập email">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Địa Chỉ</label>
                                <input v-model="edit_nha_cung_cap.dia_chi" type="text" class="form-control shadow-sm" placeholder="Nhập địa chỉ">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Mã Số Thuế</label>
                                <input v-model="edit_nha_cung_cap.ma_so_thue" type="text" class="form-control shadow-sm" placeholder="Nhập mã số thuế">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-bold">Ghi Chú</label>
                                <textarea v-model="edit_nha_cung_cap.ghi_chu" class="form-control shadow-sm" rows="3" placeholder="Nhập ghi chú"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary shadow-sm" data-bs-dismiss="modal">Đóng</button>
                    <button type="button" class="btn btn-warning shadow-sm px-4" @click="editNhaCungCap">Lưu Thay Đổi</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-danger px-4 shadow-sm" @click="xoaNhaCungCap">Xác Nhận Xóa</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        prepareEdit(item) {
            this.edit_nha_cung_cap = { ...item };
        },
        prepareDelete(item) {
            this.xoa_nha_cung_cap = item;
        },
        editNhaCungCap() {
            axios
